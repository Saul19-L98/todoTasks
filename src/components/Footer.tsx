const Footer = () => {
  return (
    <footer className="flex justify-center items-center h-16 bg-gray-100" style={{"position":"absolute",
        "left":0,
        "bottom":0,
        "right":0}}>
        <a
        ...
        >
            <svg
            className="w-6 h-6 mr-3 transition-transform duration-200 ease-in-out transform hover:translate-y-1"
            fill="currentColor"
            viewBox="0 0 24 24"
